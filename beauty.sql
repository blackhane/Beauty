...
-- 테이블 데이터 beauty.cart:~12 rows (대략적) 내보내기
INSERT INTO `cart` (`cartNo`, `uid`, `prodNo`, `count`, `color`, `size`, `rdate`) VALUES
	...
	(48, 'sinsunkangg@naver.com', 601, 1, '라이트핑크', 'M', '2023-05-11 01:45:34'),
	(49, 'sinsunkangg@naver.com', 634, 3, '베이지', 'FREE', '2023-05-11 01:46:38'),
	(50, '15fa07a1-0708-4f41-9676-f96e552cacb7', 635, 1, '블랙', 'M', '2023-05-11 01:47:10'),
	(51, 'sinsunkangg@naver.com', 590, 1, '베이지', 'FREE', '2023-05-11 01:51:50'),
	(52, 'sinsunkangg@naver.com', 590, 1, '다크그레이', 'FREE', '2023-05-11 01:51:50');
...
-- 테이블 데이터 beauty.member:~3 rows (대략적) 내보내기
INSERT INTO `member` (`uid`, `pass`, `name`, `level`, `point`, `phone`, `zip`, `addr1`, `addr2`, `regip`, `rdate`, `height`, `weight`, `pass1`, `pass2`) VALUES
	...
	('admin@admin', '$2a$10$FnRsA4cGZCZUedh6MJvgN.IPXzIEg3IcPP.cjqnyhSaLMOD99oCIu', '관리자', '5', 28138, '011-0000-0000', '11', '부산진구', '11', '0:0:0:0:0:0:0:1', '2023-03-09 04:12:34', '0', '0', NULL, NULL),
	('sinsunkangg@naver.com', '$2a$10$iTdREFVUbf39opHbvOWLjej9.NET8AobKODM1/XlO1SwlpXrrH.rK', '강중현', '1', 0, '010-1234-1234', '05315', '서울 강동구 양재대로123길 7', '123', '0:0:0:0:0:0:0:1', '2023-05-11 02:50:30', '', '', NULL, NULL);
...
-- 테이블 데이터 beauty.order:~16 rows (대략적) 내보내기
INSERT INTO `order` (`ordNo`, `prodNo`, `count`, `price`, `discount`, `disPrice`, `point`, `total`, `color`, `size`, `rdate`) VALUES
	...
	(1000081, 590, 1, 54000, 0, 0, 1539, 54000, '다크그레이', 'FREE', '2023-05-11 01:01:15'),
	(1000081, 589, 1, 54000, 0, 0, 1296, 54000, '아이보리', 'M', '2023-05-11 01:01:15'),
	(1000082, 601, 1, 35400, 0, 0, 1062, 35400, '라이트핑크', 'M', '2023-05-11 01:46:13');
...
CREATE TABLE IF NOT EXISTS `ordercomplete` (
  ...
  PRIMARY KEY (`ordNo`)
) ENGINE=InnoDB AUTO_INCREMENT=1000083 DEFAULT CHARSET=utf8;

-- 테이블 데이터 beauty.ordercomplete:~12 rows (대략적) 내보내기
INSERT INTO `ordercomplete` (`ordNo`, `uid`, `password`, `ordCount`, `ordPrice`, `ordDisprice`, `ordDelivery`, `savePoint`, `usedPoint`, `total`, `orderer`, `orderHp`, `orderZip`, `orderAddr1`, `orderAddr2`, `orderEmail`, `recipName`, `recipHp`, `recipZip`, `recipAddr1`, `recipAddr2`, `message`, `payment`, `ordComplete`, `ordDate`) VALUES
	...
	(1000081, 'test@naver.com', NULL, 2, 108000, 0, 0, 2835, 0, 108000, '테테', '010-5656-6666', '46990', '부산 사상구 가야대로 1', '123', 'test@naver.com', '테테', '010-5656-6666', '46990', '부산 사상구 가야대로 1', '123', '', '1', '1', '2023-05-11 01:01:15'),
	(1000082, 'sinsunkangg@naver.com', NULL, 1, 35400, 0, 2500, 1062, 0, 37900, '강중현', '010-1234-1233', '46729', '부산 강서구 생곡동 1598-1', '123', 'sinsunkangg@naver.com', '강중현', '010-1234-1233', '46729', '부산 강서구 생곡동 1598-1', '123', '부재시 문앞', '1', '1', '2023-05-11 01:46:13');
...
-- 테이블 데이터 beauty.product:~39 rows (대략적) 내보내기
INSERT INTO `product` (`prodNo`, `prodName`, `descript`, `prodCate1`, `prodCate2`, `price`, `discount`, `disPrice`, `point`, `stock`, `sold`, `hit`, `score`, `review`, `thumb1`, `thumb2`, `thumb3`, `thumb4`, `thumb5`, `thumb6`, `detail1`, `detail2`, `detail3`, `company`, `status`, `origin`, `thick`, `flex`, `through`, `lining`, `rdate`) VALUES
	...
	(589, '여름 얇은 가디건 사무실 간절기 니트 카디건 MDN519', '여름 얇은 가디건 사무실 간절기 니트 카디건 MDN519', '100', '101', 54000, 0, 0, 1296, 0, 0, 33, 0, 0, '6f4d9764-0fc3-4b48-89ee-bbad21eac944.jpg', '56c19269-4a17-4b28-8e82-657e6276fbae.jpg', '268a7309-f101-47f1-81cf-86863fc511f6.jpg', 'f8c746aa-d202-4560-9b05-68095a2b9125.jpg', '2a989b82-4097-4d28-b51f-b6950f926a21.jpg', 'dc07ef41-79b6-43b2-9bf2-3e3f09b884d6.jpg', '095053ee-5cfb-4e6f-9f30-241e894b6757.jpg', '69d5e472-91ee-449a-a4ea-e1845f39b1f4.jpg', '0db1692f-389a-4b1d-ae31-c2fb52473b7c.jpg', '러쉬', '폴리', '한국', '얇음', '보통', '약간있음', '없음', '2023-03-03 00:00:00'),
	(590, 'G125811_(벨트세트) 더블 롱 트렌치 코트', 'G125811_(벨트세트) 더블 롱 트렌치 코트', '100', '102', 54000, 0, 0, 1539, 0, 0, 37, 0, 0, '9e0ed05d-f534-4d84-b916-79ea64db4eb4.jpg', '274a5be6-5bf5-4854-9e56-e838e8ab7eee.jpg', 'da9523eb-e2fb-4799-ad7f-6836d5205bd5.jpg', '8bebb826-2af3-437c-8e11-e05466289a2f.jpg', '61fd3c85-71d1-4063-a728-c5c8e11c6741.jpg', 'df1fc4aa-8e2e-4bdd-ab4d-71b8df55f3fd.jpg', '38efe2b7-dfb5-4478-953c-eeb5191cb3fe.jpg', '7aa67952-69a0-4933-b405-1748c752887c.jpg', '2369e2bf-4975-4d3b-b43b-8d538eca3fe8.jpg', '러쉬', '폴리', '한국', '보통', '없음', '없음', '부분안감', '2023-03-03 00:00:00'),
	(591, 'OHS-CTDD2708 여성 뽀글이 하프 코트 자켓', 'OHS-CTDD2708 여성 뽀글이 하프 코트 자켓', '100', '102', 24000, 0, 0, 648, 0, 0, 16, 0, 0, 'be6b736d-0b4b-4cfe-944b-0212d9e46e19.jpg', 'acaabe1a-f966-4ba9-b94c-12ca02eda8ce.jpg', 'a5c718d6-628d-446d-b26b-84b7aaac77f5.jpg', '997d9529-2bbd-4af6-b8d2-f21ef4912f2e.jpg', '1c52954b-e77b-4d71-8e77-42ab7932b595.jpg', '831d3c4f-18fa-4897-bef4-877300713537.jpg', '13ab7bca-2a2c-4c0c-bc7d-c3b5c3b39b57.jpg', 'da81ba61-9646-4868-84ab-efd46d0e8765.jpg', '76b50afc-c42e-42f9-80bd-0d7f10c41cc1.jpg', '러쉬', '폴리', '한국', '두꺼움', '없음', '없음', '없음', '2023-03-02 00:00:00'),
...
-- 테이블 데이터 beauty.product_option:~249 rows (대략적) 내보내기
INSERT INTO `product_option` (`prodNo`, `color`, `colorName`, `size`, `sold`) VALUES
	...
	(636, '#000000', '블랙', 'FREE', 120),
	(636, '#f5f5dc', '베이지', 'FREE', 120),
	(636, '#fffff0', '아이보리', 'FREE', 105);
